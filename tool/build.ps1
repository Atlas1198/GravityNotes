...
if ($Clean) {
    ...
    & $msbuild "GravityNotes.sln" /t:Clean /p:Configuration=$Configuration /p:Platform="x64"
...
& $msbuild "GravityNotes.sln" /p:Configuration=$Configuration /p:Platform="x64" /m /v:minimal
...
if ($exitCode -eq 0) {
    ...
    if ($Run) {
        ...
        $exePath = "x64/$Configuration/GravityNotes.exe"
